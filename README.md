...
Stäng av tredjepartstjänster/media.gmp-widevinecdm.enabled = "false", media.gmp-widevinecdm.visible = "false"
...
network.http.referer.spoofSource = false (Spoofing kan påverka CSRF)
